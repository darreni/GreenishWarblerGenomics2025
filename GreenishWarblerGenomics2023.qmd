...
```{julia}
    ...
    println("Filtering out these runs because they are duplicates of another: ", ind_with_metadata.ind[selection])
...
filter_out_inds = ["GW_Armando_plate1_AB1", "GW_Liz_GBS_P_fusc", "GW_Liz_GBS_P_h_man", "GW_Liz_GBS_P_humei", "GW_Liz_GBS_P_inor", "GW_Liz_GBS_S_burk"]
##  REMOVE 1ST ONE ABOVE
if filter
    in.(ind_with_metadata_indFiltered.ind, filter_out_inds) #DOESN'T YET WORK NOT BROADCASTING RIGHT
    selection = ind_with_metadata_indFiltered.ind in filter_out_inds
...
for i in axes(latlongs2, 1)
    ...
    print(ind_with_metadata_indFiltered_wholeGenome.ring_km)
end
```
