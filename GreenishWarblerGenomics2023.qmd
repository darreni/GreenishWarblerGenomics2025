...
function rollingMean(inputVector, windowSize)
    ...
    rollingMeans = Vector{Float32}(undef, numWindows) # set up place to store data
...
function getWindowedFst(FstNumerator, FstDenominator, pos, windowSize)
    ...
    rollingMeanFst = Array{Float32, 2}(undef, size(FstNumerator, 1), length(rollingMeanPos))
...
plot(windowedPos, windowedFst[1,:])
