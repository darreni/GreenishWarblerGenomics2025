...
ind_with_metadata_indFiltered_sex = leftjoin(GW_GenoData_indFiltered.indInfo, readDepthRatioZto2, on = :ind => :INDV)
...
x_plot_values = eachindex(ind_with_metadata_indFiltered_sex.depthRatio)
y_plot_values = ind_with_metadata_indFiltered_sex.depthRatio
CairoMakie.scatter!(ax, x_plot_values, y_plot_values, marker = :diamond, color="black", markersize=10, strokewidth=0.5)
