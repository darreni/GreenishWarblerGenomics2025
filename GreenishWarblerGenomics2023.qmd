...
```{julia}
genosOnly_ind_SNP_ind_filtered_TEST = load(filename, "genosOnly_ind_SNP_ind_filtered")
ind_with_metadata_indFiltered_TEST = load(filename, "ind_with_metadata_indFiltered")
pos_SNP_filtered_TEST = load(filename, "pos_SNP_filtered")
