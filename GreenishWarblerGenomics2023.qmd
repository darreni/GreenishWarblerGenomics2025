...
```{julia}
    ...
    println("""Filtering out these runs because they are duplicates of another, according to having "rep" in Fst_group: """, ind_with_metadata.ind[selection])
...
if filter
    ...
    println("Specific individuals filtered out as requested: ", filtered_out)
else
