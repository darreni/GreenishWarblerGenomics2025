...
Did this and saved files, so inactivated this cell for now:
...
There is a whole lot of signal for population structure in the non-LHBR regions--maybe not suprising given there are high-Fst regions with low ViSHet.
