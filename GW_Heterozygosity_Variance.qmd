...
vir_indices = (5 .< PCAmodel.metadata.PC1) .&& (PCAmodel.metadata.PC3 .< 2)
lud_indices = (5 .< PCAmodel.metadata.PC1) .&& (2 .< PCAmodel.metadata.PC3)
nit_indices = (2 .< PCAmodel.metadata.PC1 .< 4)
troch_indices = PCAmodel.metadata.PC2 .> 5
obs_indices = (-2 .< PCAmodel.metadata.PC1 .< 2) .&& (1 .< PCAmodel.metadata.PC2 .< 4)
plumb_indices = PCAmodel.metadata.PC1 .< -5

PCAmodel.metadata.Fst_group[vir_indices]
PCAmodel.metadata.Fst_group[lud_indices]
PCAmodel.metadata.Fst_group[nit_indices] # note there are two nitidus with nearly identical values
PCAmodel.metadata.Fst_group[troch_indices]
PCAmodel.metadata.Fst_group[obs_indices]
PCAmodel.metadata.Fst_group[plumb_indices]
```
