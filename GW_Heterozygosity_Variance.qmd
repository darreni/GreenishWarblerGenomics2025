...
vir_lud = (PCAmodel.metadata.PC1 .< -5)
nit = (-5 .< PCAmodel.metadata.PC1 .< -2.5)
troch = (-1 .< PCAmodel.metadata.PC1 .< 2.5) .& (PCAmodel.metadata.PC3 .< 1)
obs = (0 .< PCAmodel.metadata.PC1 .< 2) .& (1 .< PCAmodel.metadata.PC3 .< 4)
plumb = (5 .< PCAmodel.metadata.PC1)

# check the individuals in each group
PCAmodel.metadata.Fst_group[vir_lud]
PCAmodel.metadata.Fst_group[nit]
PCAmodel.metadata.Fst_group[troch]
PCAmodel.metadata.Fst_group[obs]
PCAmodel.metadata.Fst_group[plumb]

clusterArray = [vir_lud nit troch obs plumb]
...
─────┼─────────────────────────
   ...
   2 │ virLud_troch  0.03253
   3 │ virLud_obs    0.0334515
   4 │ virLud_plumb  0.041869
   5 │ nit_troch     0.0388383
   6 │ nit_obs       0.0393449
   7 │ nit_plumb     0.0476769
   8 │ troch_obs     0.0150106
   9 │ troch_plumb   0.029365
...
# choose inds with low IndHet in high HetVar region:
indSelection = (meanAcrossRegionIndHetStan .< 1.75)    
ind_with_metadata_lowIndHetStan = ind_with_metadata_included[indSelection, :]
...
vir_lud = (PCAmodel.metadata.PC1 .< -2.5)
nit = (-2 .< PCAmodel.metadata.PC1 .< 1)
troch = (-1 .< PCAmodel.metadata.PC1 .< 3) .& (PCAmodel.metadata.PC2 .< -3.2)
obs = (1 .< PCAmodel.metadata.PC1 .< 2.5) .& (-3.2 .< PCAmodel.metadata.PC2 .< -1)
plumb = (2.5 .< PCAmodel.metadata.PC1) .& (2 .< PCAmodel. PC2)
...
#= 10×2 DataFrame
 Row │ cluster_pair  Dxy       
     │ String        Float64   
─────┼─────────────────────────
   1 │ virLud_nit    0.0333784
   2 │ virLud_troch  0.0318611
   3 │ virLud_obs    0.0351041
   4 │ virLud_plumb  0.0329825
...
# choose inds with low IndHet in high HetVar region:
indSelection = (meanAcrossRegionIndHetStan .< 1.5)    
ind_with_metadata_lowIndHetStan = ind_with_metadata_included[indSelection, :]
...
vir_lud = (PCAmodel.metadata.PC1 .< -6)
nit = (-6 .< PCAmodel.metadata.PC1 .< -5)
troch = (PCAmodel.metadata.PC2 .< -6)
obs = (-6 .< PCAmodel.metadata.PC2 .< -4)
plumb = (6 .< PCAmodel.metadata.PC1) .& (2 .< PCAmodel. PC2)
