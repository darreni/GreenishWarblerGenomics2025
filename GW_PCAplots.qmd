...
if false  #set to true to save
    save("Figure_1b_from_Julia.png", PCA_wholeGenome.PCAfig, px_per_unit = 2.0)
end
```
...
if false  #set to true to save
    save("Figure_1c_from_Julia.png", f, px_per_unit = 2.0)
end
```
...
```{julia}
savefig = true  #set to true to save the figures from cells below
```
