...
function getIndGenDistances(genotypeMatrix)
    ...
    for i in 1:numInds
        for j in 1:numInds
            ...
            distanceMatrix[i,j] = (fullMismatches + 0.5partialMismatches + 0*bothHet) / size(geno_indFiltered_highHetVarRegion_ordered, 2)
        end
    end
...
indSelection = (ind_with_metadata_included.regionIndHetStan .< 1000)    # 0.75
...
geno_lowIndHetStan[geno_lowIndHetStan .== -1] .= missing
